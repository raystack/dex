...
func (o *ScaleFirehoseOK) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/scale][%d] scaleFirehoseOK  %+v", 200, o.Payload)
}
...
func (o *ScaleFirehoseBadRequest) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/scale][%d] scaleFirehoseBadRequest  %+v", 400, o.Payload)
}
...
func (o *ScaleFirehoseNotFound) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/scale][%d] scaleFirehoseNotFound  %+v", 404, o.Payload)
}
...
func (o *ScaleFirehoseInternalServerError) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/scale][%d] scaleFirehoseInternalServerError  %+v", 500, o.Payload)
}
