...
func (o *ResetOffsetOK) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/reset][%d] resetOffsetOK  %+v", 200, o.Payload)
}
...
func (o *ResetOffsetBadRequest) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/reset][%d] resetOffsetBadRequest  %+v", 400, o.Payload)
}
...
func (o *ResetOffsetNotFound) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/reset][%d] resetOffsetNotFound  %+v", 404, o.Payload)
}
...
func (o *ResetOffsetInternalServerError) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/reset][%d] resetOffsetInternalServerError  %+v", 500, o.Payload)
}
