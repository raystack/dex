...
func (o *StartFirehoseOK) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/start][%d] startFirehoseOK  %+v", 200, o.Payload)
}
...
func (o *StartFirehoseBadRequest) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/start][%d] startFirehoseBadRequest  %+v", 400, o.Payload)
}
...
func (o *StartFirehoseNotFound) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/start][%d] startFirehoseNotFound  %+v", 404, o.Payload)
}
...
func (o *StartFirehoseInternalServerError) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/start][%d] startFirehoseInternalServerError  %+v", 500, o.Payload)
}
