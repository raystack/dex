...
// WithID adds the id to the get project by Id params
func (o *GetProjectByIDParams) WithID(id string) *GetProjectByIDParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get project by Id params
func (o *GetProjectByIDParams) SetID(id string) {
	o.ID = id
}
