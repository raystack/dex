...
type ClientService interface {
	...
	SetGroupAlertChannels(params *SetGroupAlertChannelsParams, opts ...ClientOption) (*SetGroupAlertChannelsOK, error)
...
func (a *Client) SetGroupAlertChannels(params *SetGroupAlertChannelsParams, opts ...ClientOption) (*SetGroupAlertChannelsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewSetGroupAlertChannelsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "setGroupAlertChannels",
		Method:             "PUT",
		PathPattern:        "/dex/subscriptions/groups/{id}/alert_channels",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &SetGroupAlertChannelsReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*SetGroupAlertChannelsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for setGroupAlertChannels: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
