...
func (o *StopFirehoseOK) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/stop][%d] stopFirehoseOK  %+v", 200, o.Payload)
}
...
func (o *StopFirehoseBadRequest) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/stop][%d] stopFirehoseBadRequest  %+v", 400, o.Payload)
}
...
func (o *StopFirehoseNotFound) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/stop][%d] stopFirehoseNotFound  %+v", 404, o.Payload)
}
...
func (o *StopFirehoseInternalServerError) Error() string {
	return fmt.Sprintf("[POST /projects/{projectId}/firehoses/{firehoseUrn}/stop][%d] stopFirehoseInternalServerError  %+v", 500, o.Payload)
}
