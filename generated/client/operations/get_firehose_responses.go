...
func (o *GetFirehoseOK) Error() string {
	return fmt.Sprintf("[GET /projects/{projectId}/firehoses/{firehoseUrn}][%d] getFirehoseOK  %+v", 200, o.Payload)
}
...
func (o *GetFirehoseNotFound) Error() string {
	return fmt.Sprintf("[GET /projects/{projectId}/firehoses/{firehoseUrn}][%d] getFirehoseNotFound  %+v", 404, o.Payload)
}
...
func (o *GetFirehoseInternalServerError) Error() string {
	return fmt.Sprintf("[GET /projects/{projectId}/firehoses/{firehoseUrn}][%d] getFirehoseInternalServerError  %+v", 500, o.Payload)
}
