...
func (o *UpdateFirehoseOK) Error() string {
	return fmt.Sprintf("[PUT /projects/{projectId}/firehoses/{firehoseUrn}][%d] updateFirehoseOK  %+v", 200, o.Payload)
}
...
func (o *UpdateFirehoseBadRequest) Error() string {
	return fmt.Sprintf("[PUT /projects/{projectId}/firehoses/{firehoseUrn}][%d] updateFirehoseBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateFirehoseNotFound) Error() string {
	return fmt.Sprintf("[PUT /projects/{projectId}/firehoses/{firehoseUrn}][%d] updateFirehoseNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateFirehoseInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /projects/{projectId}/firehoses/{firehoseUrn}][%d] updateFirehoseInternalServerError  %+v", 500, o.Payload)
}
