...
// WithProjectID adds the projectID to the upgrade firehose params
func (o *UpgradeFirehoseParams) WithProjectID(projectID string) *UpgradeFirehoseParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the upgrade firehose params
func (o *UpgradeFirehoseParams) SetProjectID(projectID string) {
