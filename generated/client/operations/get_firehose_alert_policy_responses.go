...
func (o *GetFirehoseAlertPolicyOK) Error() string {
	return fmt.Sprintf("[GET /projects/{projectId}/firehoses/{firehoseUrn}/alertPolicy][%d] getFirehoseAlertPolicyOK  %+v", 200, o.Payload)
}
...
func (o *GetFirehoseAlertPolicyNotFound) Error() string {
	return fmt.Sprintf("[GET /projects/{projectId}/firehoses/{firehoseUrn}/alertPolicy][%d] getFirehoseAlertPolicyNotFound  %+v", 404, o.Payload)
}
...
func (o *GetFirehoseAlertPolicyInternalServerError) Error() string {
	return fmt.Sprintf("[GET /projects/{projectId}/firehoses/{firehoseUrn}/alertPolicy][%d] getFirehoseAlertPolicyInternalServerError  %+v", 500, o.Payload)
}
