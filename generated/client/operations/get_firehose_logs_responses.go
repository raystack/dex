...
func (o *GetFirehoseLogsBadRequest) Error() string {
	return fmt.Sprintf("[GET /projects/{projectId}/firehoses/{firehoseUrn}/logs][%d] getFirehoseLogsBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetFirehoseLogsNotFound) Error() string {
	return fmt.Sprintf("[GET /projects/{projectId}/firehoses/{firehoseUrn}/logs][%d] getFirehoseLogsNotFound  %+v", 404, o.Payload)
}
...
func (o *GetFirehoseLogsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /projects/{projectId}/firehoses/{firehoseUrn}/logs][%d] getFirehoseLogsInternalServerError  %+v", 500, o.Payload)
}
