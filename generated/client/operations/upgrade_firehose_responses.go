...
func (o *UpgradeFirehoseOK) Error() string {
	return fmt.Sprintf("[POST /projects/{projectSlug}/firehoses/{firehoseUrn}/upgrade][%d] upgradeFirehoseOK  %+v", 200, o.Payload)
}
...
func (o *UpgradeFirehoseNotFound) Error() string {
	return fmt.Sprintf("[POST /projects/{projectSlug}/firehoses/{firehoseUrn}/upgrade][%d] upgradeFirehoseNotFound  %+v", 404, o.Payload)
}
...
func (o *UpgradeFirehoseInternalServerError) Error() string {
	return fmt.Sprintf("[POST /projects/{projectSlug}/firehoses/{firehoseUrn}/upgrade][%d] upgradeFirehoseInternalServerError  %+v", 500, o.Payload)
}
