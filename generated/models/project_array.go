...
func (m *ProjectArray) validateItems(formats strfmt.Registry) error {
...
func (m *ProjectArray) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
