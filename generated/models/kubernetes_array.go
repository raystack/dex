...
func (m *KubernetesArray) validateItems(formats strfmt.Registry) error {
...
func (m *KubernetesArray) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
