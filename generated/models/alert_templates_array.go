...
func (m *AlertTemplatesArray) validateItems(formats strfmt.Registry) error {
...
func (m *AlertTemplatesArray) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
